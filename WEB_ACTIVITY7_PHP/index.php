...
session_start();
    ...
    if($email=="morenoflore8@gmail.com" && $password=="1234"){
       
        $_SESSION['email']=$email;
        $_SESSION['password']=$password;

        $message="<div class='alert alert-success'>Logged in succcessfully!</div>";
        ...
        $message="<div class='alert alert-danger '>Logged in Failed!</div>";
